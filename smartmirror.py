            ...
            if intent is not None:
                if intent == 'weather':
                    ...
                    if location is not  None:
                        self.pyqt_change_url(self.URL_FORECAST.format(location))
                    else:
                ...
                self.pyqt_change_url(self.URL_USER_HOME.format(name), 'I do not understand the intend of your statement.')
